...
#PLOT
ax.plot(time,flux_un,color="blue",marker=".",markersize=6,linewidth=0,linestyle="-",label="Untrended Flux")
ax.plot(time,flux_de,color="red",marker=".",markersize=6,linewidth=0,linestyle="-",label="Detrended Flux")
...
#SAVING
fig.show()
fig.savefig("detrend_vs_untrend.png")
